...
<body>
	...
	<div class="page">
		<div class="blog-page">
			<div class="sidebar">
				<a href="index.php" id="logo"><img src="images/logo2.png" width="87" alt="logo"></a>
				<ul>
					<li class="home">
				...
				<div class="content-blog-single">
					<div>
						<div>
							...
							<div class="paging">
								<a href="15-Details-of-Metal-Structures-and-Facades.php" class="next">Blogpost With Video</a>
							</div>
							<ul>
								<li>
